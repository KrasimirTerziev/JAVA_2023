...
public class AddVehicleCommand extends BaseCommand {
    ...
    protected String executeCommand(List<String> parameters) {
        ...
        com.company.oop.dealership.models.enums.Tasks type = ParsingHelpers.tryParseEnum(parameters.get(0), com.company.oop.dealership.models.enums.Tasks.class);
    ...
    private String addVehicle(com.company.oop.dealership.models.enums.Tasks type, String make, String model, double price, String additionalParam) {
        Tasks vehicle = createVehicle(type, make, model, price, additionalParam);
    ...
    private Tasks createVehicle(com.company.oop.dealership.models.enums.Tasks type, String make, String model, double price, String additionalParam) {
        switch (type) {
            case CAR:
