...
public class LoginTests {
    ...
    public void should_Throw_When_UserAlreadyLoggedIn() {
        // Arrange
        Members userToLogIn = loginInitializedUserToRepository(repository);
        List<String> params = List.of(userToLogIn.getUsername(), userToLogIn.getPassword());
    ...
    public static Members loginInitializedUserToRepository(VehicleDealershipRepository repository) {
        Members testUser = initializeTestUser();
