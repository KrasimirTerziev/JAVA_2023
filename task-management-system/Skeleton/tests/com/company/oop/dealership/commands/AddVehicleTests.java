...
import com.company.oop.dealership.models.contracts.Board;
import com.company.oop.dealership.models.contracts.Team;
import com.company.oop.dealership.models.enums.Tasks;
...
public class AddVehicleTests {
    ...
    public void should_CreateMotorcycle_When_InputIsValid() {
        ...
        //Assert
        Board motorcycle = (Board) repository.getLoggedInUser().getVehicles().get(0);
    ...
    public void should_CreateTruck_When_InputIsValid() {
        ...
        //Assert
        Team truck = (Team) repository.getLoggedInUser().getVehicles().get(0);
