...
public class VehicleDealershipRepositoryTests {
    ...
    public void addUser_Should_ThrowException_When_UserAlreadyExists() {
        // Arrange
        Members user = addInitializedUserToRepo(repository);
    ...
    public void addUser_Should_AddUser_When_UserDoesNotExist() {
        // Arrange
        Members user = UserImplTests.initializeTestUser();
    ...
    public void findUserByUsername_Should_ReturnUser_When_UserExists() {
        ...
        // Act
        Members foundUser = repository.findUserByUsername(user.getUsername());
    ...
    public void getLoggedInUser_Should_ReturnUser_When_UserIsLoggedIn() {
        // Arrange
        Members user = LoginTests.loginInitializedUserToRepository(repository);

        // Act
        Members loggedInUser = repository.getLoggedInUser();
    ...
    public void createMotorcycle_Should_ReturnMotorcycle_When_InputIsValid() {
        // Arrange, Act
        Board testMotorcycle = repository.createMotorcycle(
                VehicleBaseConstants.VALID_MAKE,
                VehicleBaseConstants.VALID_MODEL,
                VehicleBaseConstants.VALID_PRICE,
                VALID_CATEGORY
    ...
    public void createTruck_Should_ReturnTruck_When_InputIsValid() {
        // Arrange, Act
        Team testTruck = repository.createTruck(
                VehicleBaseConstants.VALID_MAKE,
                VehicleBaseConstants.VALID_MODEL,
                VehicleBaseConstants.VALID_PRICE,
                VALID_WEIGHT_CAP
    ...
    public void createUser_Should_ReturnUser_When_InputIsValid() {
        // Arrange, Act
        Members testUser = repository.createUser(
    ...
    public static Members addInitializedUserToRepo(VehicleDealershipRepository repository) {
        Members testUser = UserImplTests.initializeTestUser();
