 ...
 * <p>
 * The Uniform Cost Search (UCS) algorithm is also implemented.
 * <p>
 * The software also implements Dijkstra's algorithm,
 * as just described in the relevant article in Wikipedia.
 * http://en.wikipedia.org/wiki/Dijkstra%27s_algorithm
 * <p>
 * The superiority of  A*, Dijkstra's and UCS algorithms against the other three becomes obvious.
 * <p>
    ...
    public static class MazePanel extends JPanel {
        ...
        private class AboutBox extends JDialog {
            ...
            public AboutBox(Frame parent, boolean modal) {
                ...
                JLabel version = new JLabel("Version: 8.0", JLabel.CENTER);
        ...
        JRadioButton dfs, bfs, aStar, greedy, dijkstra, ucs;
        ...
        public MazePanel(int width, int height) {
            ...
            ucs = new JRadioButton("UCS");
            ucs.setToolTipText("Uniform Cost Search algorithm");
            algoGroup.add(ucs);
            ...
            greedy.setBounds(605, 390, 75, 25);
            dijkstra.setBounds(530, 410, 75, 25);
            ucs.setBounds(605, 410, 70, 25);
        ...
        public void checkTermination() {
            ...
            // In the case of DFS, BFS, A*, Greedy and UCS algorithms
        ...
        private void expandNode() {
            ...
            if (dijkstra.isSelected()) {
                ...
                if (dfs.isSelected() || bfs.isSelected()) {
                    ...
                    // Here is the 3rd step of the algorithms A*, Greedy and UCS
                    // 3. Remove the first state, Si, from OPEN SET,
                ...
                for (Cell cell : successors) {
                    ...
                    if (dfs.isSelected()) {
                        ...
                        // Update the color of the cell
                        grid[cell.row][cell.col] = FRONTIER;
                        // ... if we are running A*, Greedy or UCS algorithms (step 5) ...
                    } else if (aStar.isSelected() || greedy.isSelected() || ucs.isSelected()) {
