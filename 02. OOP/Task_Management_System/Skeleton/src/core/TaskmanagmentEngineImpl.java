...
import core.contracts.TaskmanagmentEngine;
...
public class TaskmanagmentEngineImpl implements TaskmanagmentEngine {
    ...
    private final TaskManagmentRepositoryImpl TaskManagmentRepository;

    public TaskmanagmentEngineImpl() {
        this.commandFactory = new CommandFactoryImpl();
        this.TaskManagmentRepository = new TaskManagmentRepositoryImpl();
    }
    ...
    private void processCommand(String inputLine) {
        ...
        Command command = commandFactory.createCommandFromCommandName(commandName, TaskManagmentRepository);
